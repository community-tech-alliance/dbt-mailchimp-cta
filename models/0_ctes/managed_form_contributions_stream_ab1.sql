{{ config(
    ...
    schema = "_airbyte_actblue_test",
    tags = [ "top-level-intermediate" ]
) }}
-- SQL model to parse JSON blob stored in a single column and extract into separated field columns as described by the JSON Schema
-- depends_on: {{ source('actblue_test', '_airbyte_raw_managed_form_contributions_stream') }}
select
...
from {{ source('actblue_test', '_airbyte_raw_managed_form_contributions_stream') }} as table_alias
