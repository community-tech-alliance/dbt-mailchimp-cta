...
-- depends_on: {{ source('mailchimp', '_airbyte_raw_managed_form_contributions_stream') }}
select
...
from {{ source('mailchimp', '_airbyte_raw_managed_form_contributions_stream') }} as table_alias
