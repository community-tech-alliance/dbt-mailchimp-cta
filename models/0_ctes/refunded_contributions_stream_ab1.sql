...
-- depends_on: {{ source('actblue_test', '_airbyte_raw_refunded_contributions_stream') }}
select
...
from {{ source('actblue_test', '_airbyte_raw_refunded_contributions_stream') }} as table_alias
